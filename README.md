...
Backend developer specialized in **PHP & Laravel**, with experience building and maintaining SaaS platforms at scale — including systems serving **700,000+ end users** and async, queue-driven messaging handling **~12,000 localized messages/day**.

I care about clean APIs, reliable data layers, and testing the failure cases before they happen in production.
...
**Focus areas:** queues & jobs · database transactions & locking · API design · localization · automated testing
